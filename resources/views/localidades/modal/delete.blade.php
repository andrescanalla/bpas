<div class="modal fade modal-slide-in-rigth" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$visita->id}}">
  {{Form::open(['action'=>array('LocalidadController@destroy',$visita->id),'method'=>'delete'])}}
    <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Eliminar {{$visita->nombreLocalidad}} </h4>
          </div>
          <div class="modal-body">
          Esta Seguro que quiere eliminar la Localidad
          </div>
