          ...
          <div class="row">
            <div class="col-lg-12 col-sm-6 col-md-6 col-xs-12">
              <div class="form-group">
                <label>Fecha:</label>
                <input type="text" name="fecha_comentario" required  value="{{$comentario->fecha_comentario->format('d/m/Y')}}" class="form-control" placeholder="29/01/2014 ...">
            ...
            <label>Comentarios</label>
                <textarea type="text" rows="4" name="comentarios" class="form-control" placeholder="cometarios ...">{{$comentario->comentarios}}</textarea>                                                        
            </div>
            </div>
        </div>
